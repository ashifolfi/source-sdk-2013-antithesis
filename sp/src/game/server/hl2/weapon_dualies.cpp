...
//========= Modified by Ashifolfi ============//
//
// Purpose:		Dual Dualiess - hand gun
//
// $NoKeywords: $
//=============================================================================//
...
#ifdef MAPBASE
	// Dualiess are their own backup activities
...
#ifdef MAPBASE
// Allows Weapon_BackupActivity() to access the dualies's activity table.
acttable_t *GetDualiesActtable()
{
	return CWeaponDualies::m_acttable;
}

int GetDualiesActtableCount()
{
	return ARRAYSIZE(CWeaponDualies::m_acttable);
}
#endif
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponDualies::FireNPCPrimaryAttack( CBaseCombatCharacter *pOperator, Vector &vecShootOrigin, Vector &vecShootDir )
{
	CSoundEnt::InsertSound( SOUND_COMBAT|SOUND_CONTEXT_GUNFIRE, pOperator->GetAbsOrigin(), SOUNDENT_VOLUME_PISTOL, 0.2, pOperator, SOUNDENT_CHANNEL_WEAPON, pOperator->GetEnemy() );
...
//-----------------------------------------------------------------------------
void CWeaponDualies::Operator_ForceNPCFire( CBaseCombatCharacter *pOperator, bool bSecondary )
{
